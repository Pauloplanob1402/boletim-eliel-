        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background:${COLORS.bg};">
          ...
          <tr>
            <td style="padding:8px 4px 28px; font-size:17px; line-height:1.65; color:${COLORS.dim};">
              ...
              <p>Enquanto isso, já separei uma coisa pra você: <a href="${process.env.APP_URL}/edicao-exemplo" style="color:${COLORS.red};">a edição #47 na íntegra</a>, de graça, pra você já entrar no clima antes da primeira edição paga chegar.</p>
